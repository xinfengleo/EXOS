...
#GameBot
-keep class com.gamebot.sdk.webapi.model.** { *; }
-keep class com.gamebot.sdk.core.CoreService { *; }
-keep class com.gamebot.sdk.core.request.* { *; }
-keep class com.gamebot.sdk.core.response.* { *; }


-keep class com.gamebot.botdemo.entity.* { *; }

-keep class com.fauth.library.** { *; }